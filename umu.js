/*
//like
var comment_list=$$("#comment-list>div")
for(var i=0;i<comment_list.length;i++){
    var did=comment_list[i].getAttribute("data-id")
    console.log(did);
    var httpRequest = new XMLHttpRequest();
    httpRequest.open('POST', 'https://m.umu.cn/uapi/v1/like/save', true); 
    httpRequest.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    httpRequest.send('obj_type=4&obj_id='+did_like+'&action=like');
...
console.log("you have got:"+i+"*2="+2*i+"points")
...
console.log("you have got:"+i+"*5="+5*i+"points")
...
console.log("you have got:"+i+"*7="+7*i+"points")
